...
$(document).ready(function() {
  ...
  function setLanguage(lang) {
	  $("[i18n]").i18n({
		  ...
		  callback: function() {
			  $("#lang-skin").remove();
			  $("head").append('<link id="lang-skin" rel="stylesheet" href="module/css/'+ lang +'skin.css">');
			  $(".langtxt").text($(".lang a[data-lang='"+ lang +"']").eq(0).text());
			  $(".lang a[data-lang='"+ lang +"']").addClass("active");
		  }
	  });
  }
